...
fun DescriptionCredits(){
    Column (modifier = Modifier.padding(4.dp,0.dp),
        horizontalAlignment = Alignment.CenterHorizontally) {
        Text(text = "This app was developed by a group of students from the CIFP César Manrique. This app was developed as a final project for the courses PGL & DAD. The app was developed using Jetpack Compose and Kotlin.\n\n This app was developed by the students:",
            fontSize = 16.sp,
